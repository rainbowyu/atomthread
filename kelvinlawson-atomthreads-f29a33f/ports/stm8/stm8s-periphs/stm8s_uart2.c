...
void UART2_Init(u32 BaudRate, UART2_WordLength_TypeDef WordLength, UART2_StopBits_TypeDef StopBits, UART2_Parity_TypeDef Parity, UART2_SyncMode_TypeDef SyncMode, UART2_Mode_TypeDef Mode)
{
    ...
    if ((u8)(Mode & UART2_MODE_RX_ENABLE))
    {
        /* Set the Receiver Enable bit */
        UART2->CR2 |= (u8)UART2_CR2_REN;
    }
    else
    {
    ...
    if ((u8)(SyncMode & UART2_SYNCMODE_CLOCK_DISABLE))
    {
        /* Clear the Clock Enable bit */
        UART2->CR3 &= (u8)(~UART2_CR3_CKEN); 
    }
    else
    {
...
u16 UART2_ReceiveData9(void)
{
  ...
  temp = ((u16)(((u16)((u16)UART2->CR1 & (u16)UART2_CR1_R8)) << 1));
  
  return (u16)((((u16)UART2->DR) | temp) & ((u16)0x01FF));
}
...
void UART2_SendData9(u16 Data)
{
    ...
    UART2->CR1 &= ((u8)~UART2_CR1_T8);                  
    
    /* Write the transmit data bit [8] */
    UART2->CR1 |= (u8)(((u8)(Data >> 2)) & UART2_CR1_T8); 
